...
namespace WindowsFormsApp1 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class TestDataTable : global::System.Data.TypedTableBase<TestRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TestRow AddTestRow(string Name, string State) {
        ...
        public partial class TestRow : global::System.Data.DataRow {
            ...
            public string State {
                get {
                    try {
                        return ((string)(this[this.tableTest.StateColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'State\' in table \'Test\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTest.StateColumn] = value;
                }
            }
            ...
            public bool IsStateNull() {
                return this.IsNull(this.tableTest.StateColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetStateNull() {
                this[this.tableTest.StateColumn] = global::System.Convert.DBNull;
            }
        }
    ...
    public partial class TestTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Test] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND " +
                "[Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_State = 1 AND [State" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Test] ([Name], [State]) VALUES (@Name, @State);\r\nSELECT Id, Na" +
                "me, State FROM Test WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Test] SET [Name] = @Name, [State] = @State WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_State = 1 AND [State] IS NULL) OR ([State] = @Original_State)));
SELECT Id, Name, State FROM Test WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, State FROM dbo.Test";
